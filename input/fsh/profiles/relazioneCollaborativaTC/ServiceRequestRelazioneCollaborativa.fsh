...
* identifier ^short = "IdRichesta, identificativo della richiesta di teleconsulto."
* identifier ^definition = "Identificativo della richiesta di teleconsulto."
...
* category 1..
* category ^short = "Branca medica richiesta"
* category ^definition = "Branca medica per la quale si effettua la richiesta di Teleconsulto"
...
* occurrence[x] ^short = "Data della ricezione della richiesta di teleconsulto."
...
* requester ^short = "Richiedente del teleconsulto"
* requester ^definition = "Elemento di tipo Reference che contiene il riferimento al richiedente."

* performer only Reference(PractitionerTeleconsulto or PractitionerRoleTeleconsulto)
* performer ^short = "Esecutore del teleconsulto"
* performer ^definition = "Elemento di tipo Reference che contiene il riferimento alle risorse, Practitioner, PractitionerRole."
