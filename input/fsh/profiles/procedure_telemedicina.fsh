...
* partOf only Reference(Procedure or ObservationTeleconsulto)
...
* performer.actor only Reference(PractitionerTeleconsulto or PractitionerRoleTeleconsulto or OrganizationT1 or Patient)
