...
* identifier ^short = "Identificativo del professionista sanitario"
...
* identifier[codiceFiscale] ^short = "Codice Fiscale del professionista sanitario"
* identifier[codiceFiscale].system = $cf (exactly)

* name 1..
* name ^short = "Nome e cognome del professionista sanitario"
...
* name.family 1..
* name.family ^short = "Cognome del professionista sanitario"
* name.given 1.. 
* name.given ^short = "Nome del professionista sanitario"